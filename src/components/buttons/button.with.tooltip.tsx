...
const StyledLinkButtonWithToolTip = (props: { text: string, action: () => void, icon?: any }) => {
  return (
    <button onClick={props.action} className="group relative primary-link background-transparent font-bold uppercase p-1 m-1 text-sm outline-none focus:outline-none ease-linear transition-all duration-150">
      {props.icon}
